...
> 🛑 **Deprecated**\
> The custom configuration file was deprecated in **`v1.2.0`**. While it is still supported for backward compatibility, it is now considered legacy. Using extension settings is recommended instead.
